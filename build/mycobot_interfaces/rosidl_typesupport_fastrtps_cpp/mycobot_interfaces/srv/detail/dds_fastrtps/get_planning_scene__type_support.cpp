...
// functions for mycobot_interfaces::srv::GetPlanningScene_Request already declared above

// functions for mycobot_interfaces::srv::GetPlanningScene_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mycobot_interfaces
cdr_serialize(
  const mycobot_interfaces::srv::GetPlanningScene_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mycobot_interfaces::srv::GetPlanningScene_Event & ros_message)
{
  // Member: info
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mycobot_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_GetPlanningScene_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mycobot_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_GetPlanningScene_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mycobot_interfaces::srv::GetPlanningScene_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mycobot_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GetPlanningScene_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mycobot_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GetPlanningScene_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const mycobot_interfaces::srv::GetPlanningScene_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mycobot_interfaces::srv::GetPlanningScene_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_mycobot_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<mycobot_interfaces::srv::GetPlanningScene_Event>()
{
  return &mycobot_interfaces::srv::typesupport_fastrtps_cpp::_GetPlanningScene_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mycobot_interfaces, srv, GetPlanningScene_Event)() {
  return &mycobot_interfaces::srv::typesupport_fastrtps_cpp::_GetPlanningScene_Event__handle;
}
...
static const rosidl_service_type_support_t _GetPlanningScene__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<mycobot_interfaces::srv::GetPlanningScene_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<mycobot_interfaces::srv::GetPlanningScene_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<mycobot_interfaces::srv::GetPlanningScene_Event>(),
  &::rosidl_typesupport_cpp::service_create_event_message<mycobot_interfaces::srv::GetPlanningScene>,
  &::rosidl_typesupport_cpp::service_destroy_event_message<mycobot_interfaces::srv::GetPlanningScene>,
